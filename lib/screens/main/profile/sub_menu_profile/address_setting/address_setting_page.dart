...
class _BodyState extends State<_Body> {
  ...
  void initState() {
    super.initState();
    context.read<AddressSettingState>().getAll();
...
class _Address1FormState extends State<_Address1Form> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      _controller.text = state.profileList![0].alamat!;
      state.address = state.profileList![0].alamat!;
    });
  }
...
class _Address2FormState extends State<_Address2Form> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      _controller.text = state.profileList![0].alamat2!;
      state.address2 = state.profileList![0].alamat2!;
    });
  }
...
class _Address3FormState extends State<_Address3Form> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      _controller.text = state.profileList![0].alamat3!;
      state.address3 = state.profileList![0].alamat3!;
    });
  }
...
class _PostcodeFormState extends State<_PostcodeForm> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      _controller.text = state.profileList![0].poskod!;
      state.postcode = state.profileList![0].poskod!;
    });
  }
...
class _BandarFormState extends State<_BandarForm> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      _controller.text = state.profileList![0].bandar!;
      state.bandar = state.profileList![0].bandar!;
    });
  }
    ...
    return Consumer<AddressSettingState>(
      builder: (_, state, __) {
        return AppSelectField(
          ...
          label: 'State',
          hint: state.profileList![0].pilihanNegeri! != ''
...
class _Button extends StatelessWidget {
  ...
  _onSubmitted(BuildContext context) async {
    ...
    state.postUpdateAddress(context);
  }
}
