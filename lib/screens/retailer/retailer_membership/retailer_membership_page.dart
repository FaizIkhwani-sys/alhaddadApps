...
class RetailerMembershipPage extends StatelessWidget {
  const RetailerMembershipPage({Key? key}) : super(key: key);
...
/// Main example page
class _AccordionPage extends StatelessWidget //__
{
  const _AccordionPage({Key? key}) : super(key: key);
