...
class RetailerStockPage extends StatelessWidget {
  const RetailerStockPage({Key? key}) : super(key: key);
    ...
    return Consumer<RetailerProfileState>(
      builder: (_, state, __) {
        return GridView.builder(
          ...
          shrinkWrap: true,
          itemCount: state.retailerStockAll!.length,
          itemBuilder: (BuildContext context, int i) {
            return _StockCard(
              image: state.retailerStockAll![i].image,
              productName: state.retailerStockAll![i].name,
              stock: state.retailerStockAll![i].kuantiti,
            );
          },
